...
class ShareViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    override func viewDidLoad() {
        ...
        let alertTitle = "Unable to import to Z-Gate Agent Mobile"
        self.fileLabel.text = ""
    ...
    @IBAction func onCancelButton(_ sender: Any) {
        let error = NSError(domain: "Z-Gate Agent Mobile Share", code: 0, userInfo: [NSLocalizedDescriptionKey: "User canceled request"])
